...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2220.4611100153593; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1181.2943859200268; // x position of the perpendicular encoder (in tick units)
    }
